        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <div className="bg-blue-50 rounded-3xl p-8 border border-blue-100">
              ...
              <button className="group bg-blue-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 ease-out hover:bg-blue-700 hover:shadow-xl hover:-translate-y-1 active:translate-y-0 active:scale-95">
